...
::: {.callout-important title="Formulas must start with `=`"}
...
![Design of a calculation model.At the left 1 worksheet, at the right 3 worksheets.](images/calculations/calculation-model.png){#fig-calculation-model}
...
::: {.callout-note title="Cell ranges"}
A (cell)range is a group of cells that you can refer to in a formula. Ranges are typically rectangular and defined by the cell in the upper-left corner, a colon, and the cell in the lower-right corner (e.g., B2:E7, B3:E3, D2:D6).
:::
...
::: {.callout-note title="Adjustments to cell addresses in copy actions"}
...
::: {.callout-important title="Use double quotes for text in Boolean formulas"}
...
::: {.callout-tip title="Select multiple names"}
...
::: {.callout-note title="Editing names"}
