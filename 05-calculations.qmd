...
`r hide("Hint")` 1. The dollar exchange rate and the VAT percentage are input variables for the calculation and should be placed at the top of the worksheet, separated from the price table. An explanatory text is in the cells before.
...
6.  Finally, all euro amounts should be formatted as currencies. `r unhide()`
