...
```{r salesman, echo=FALSE}
seller <- c("Anderson","Brown", "Gonzalez", "Hernandez", "Johnson", "King", "Lewis", "Miller", "Phillips", "Smith", "Williams")
names(seller)[9] = "answer"
month <- c("jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec")
names(month)[1] = "answer"
```
...
2. In which month of which year were software sales the highest?
   Year `r mcq(c(2010, answer=2011))`, Month `r mcq(month)`
