...
::: {.callout-note title="Visibility of the Task Pane"}
...
::: {.callout-tip title="Removing Fields"}
...
::: {.callout-note title="Value Field Settings"}
...
::: {.callout-note title="Data area and PivotTable location"}
...
::: {.callout-note title="Automatic Time Grouping"}
...
::: {.callout-note title="Timeline Features"}
