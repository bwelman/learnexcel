...
::: {.callout-note title="Macros and VBA"}
...
::: {.callout-important title="Check for Developer Tab"}
...
::: {.callout-tip title="Developing Macros"}
...
::: {.callout-note title="Macro Properties"}
...
::: {.callout-warning title="File extension for macros"}
...
::: {.callout-important title="Relative References"}
...
Create a macro that ensures gridlines will be printed for the active sheet. This setting can be found under[Page Layout tab \> Page Setup group (dialog launcher) \> Sheet tab]{.uicontrol}.
