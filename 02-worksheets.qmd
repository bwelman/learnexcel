...
::: {.callout-tip title="New selection after Enter"}
You can change this direction in [File \> Options \> Advanced]{.uicontrol}: down, up, right, and left.
:::
...
::: {.callout-tip title="Tips for mouse selections"}
...
::: {.callout-important title="Do not enter content and formatting at the same time"}
...
::: {.callout-tip title="Accessing Page Setup options"}
