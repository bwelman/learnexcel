...
::: {.callout-important title="List separator"}
...
::: {.callout-tip title="Help for the function"}
...
4.  Confirm the selection by doing one of the following:
    ...
    -   Click the [Enter]{.uicontrol} button, ![](images/functions/enter-function.png), in the formula bar.
...
::: {.callout-tip title="Selecting cell range"}
...
::: {.callout-note title="Multiple conditions"}
...
::: {.callout-note title="Argument Num-chars"}
...
::: {.callout-note title="Argument Num-chars"}
In the [Num_chars]{.uicontrol} box, enter the length of the right-hand portion. This is counted from the end of the text. In this example, the length of the right-hand portion is equal to the total length of the text (the value in B2) minus the position of the space (the value in C2).
:::
...
::: {.callout-tip title="Nesting functions"}
...
::: {.callout-tip title="Specifying entire column as range"}
...
::: {.callout-note title="Pivot tables"}
...
::: {.callout-note title="Interest rate and number of periods"}
...
::: {.callout-note title="Negative result"}
...
::: {.callout-important title="Payments"}
...
::: {.callout-tip title="Exact or approximate match"}
