...
::: {.callout-tip title="Save the current situation always in a scenario"}
...
::: {.callout-tip title="Using names in a scenario"}
...
::: {.callout-warning title="Warning when using formulas"}
