...
::: {.callout-tip title="Adjust multiple columns at once"}
...
::: {.callout-tip title="Adjust multiple rows at once"}
...
::: {.callout-note title="Text wrapping not visible"}
...
::: {.callout-note title="Dates and times are stored as numbers"}
...
::: {.callout-tip title="Apply format to multiple cells"}
...
2.  Select all the turnover data, cell C2 through cell C15.
