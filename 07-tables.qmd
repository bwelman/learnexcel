...
::: {.callout-tip title="Navigating the Form"}
...
::: {.callout-warning title="Consolidation is static"}
...
::: {.callout-note title="Table headers"}
...
::: {.callout-important title="Sorting is irreversible"}
...
::: {.callout-note title="Multi-Select mode"}
...
::: {.callout-note title="Structured references"}
