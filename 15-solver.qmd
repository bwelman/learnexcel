...
::: {.callout-note title="Solver or Goal Seek?"}
...
::: {.callout-important title="Check for Solver"}
...
::: {.callout-note title="Multiple Objectives and Indirect Variables"}
...
::: {.callout-tip title="Adding Multiple Constraints"}
...
::: {.callout-note title="Interpreting the Answer Report"}
