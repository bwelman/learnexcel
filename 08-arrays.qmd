...
::: {.callout-important title="Array formulas in Excel 365"}
...
::: {.callout-important title="Editing array formulas"}
...
::: {.callout-tip title="Entering array formulas"}
...
::: {.callout-tip title="Naming arrays"}
...
::: {.callout-note title="Understanding the XLOOKUP formula"}
Note the arguments in this formula:
...
::: {.callout-note title="Understanding the nested formula"}
