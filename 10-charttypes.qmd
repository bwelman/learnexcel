...
In @fig-line-data, you can find annual temperature data (^o^C) for Amsterdam Airport Schiphol (source: [https://en.tutiempo.net/climate/ws-62400.html](https://en.tutiempo.net/climate/ws-62400.html)).
